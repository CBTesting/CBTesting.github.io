            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Finest</h5>
                        <p>Our wine products are the finest of the bunch, order today to see for yourself.</p>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Perfection</h5>
                        <p>We are passionate about our products, so we take great pride in the quality of them.</p>
                    </div>
                </div>
                <div class="carousel-item">
